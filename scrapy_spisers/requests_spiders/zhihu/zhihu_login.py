...
def get_capt():
    ...
    z = zheye()
    input_points = z.Recognize("C:/Users/Administrator/yangjin/scrapy_spisers/scrapy_spisers/requests/zhihu/zhuhu.png")
    input_points = [[i[1] / 2, i[0] / 2] for i in input_points]
    return input_points
